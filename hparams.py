...
class Hparams:
    ...
    ## files
    parser.add_argument('--save_dir', default="t2t", help="save directory")
    ...
    parser.add_argument('--d_model', default=128, type=int, help="hidden dimension of LSTM")
    parser.add_argument('--d_ff', default=256, type=int, help="hidden dimension of LSTM")
