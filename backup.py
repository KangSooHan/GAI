...
hp.caption = hp.n_global+hp.n_action+hp.n_interaction
save_hparams(hp)

train_batches, num_train_batches, wordtoix, ixtoword, _ = get_batch(hp.caption_path, hp.video_path, hp.n_video, hp.n_global, hp.n_action, hp.n_interaction, hp.batch_size, hp.types, True, "train")

hp.word = len(ixtoword)

eval_batches, num_eval_batches, _,  _, df = get_batch(hp.caption_path, hp.video_path, hp.n_video, hp.n_global, hp.n_action, hp.n_interaction, hp.batch_size, hp.types, False, "valid")
